...
#ifdef AttOnG1_KeyOnG2
vector<G2> KPABE::genKey(const shared_ptr<BLAccessPolicy> policy)
#endif
#ifdef AttOnG2_KeyOnG1
vector<G1> KPABE::genKey(const shared_ptr<BLAccessPolicy> policy)
#endif
{
  BLSS ssscheme(policy, m_pfc);
...
#ifdef AttOnG1_KeyOnG2
vector<G2> KPABE::genKey(const shared_ptr<BLAccessPolicy>  policy, vector<Big> poly)
#endif
#ifdef AttOnG2_KeyOnG1
vector<G1> KPABE::genKey(const shared_ptr<BLAccessPolicy>  policy, vector<Big> poly)
#endif
{
  BLSS ssscheme(policy, m_pfc);
...
#ifdef AttOnG1_KeyOnG2
bool KPABE::decrypt_main_body(const shared_ptr<BLAccessPolicy> policy, vector<G2> keyFrags, const vector<int>& atts, vector<G1>& AttFrags, GT& blinder)
#endif
#ifdef AttOnG2_KeyOnG1
  bool KPABE::decrypt_main_body(const shared_ptr<BLAccessPolicy> policy, vector<G1> keyFrags, const vector<int>& atts, vector<G2>& AttFrags, GT& blinder)
#endif
{
...
#ifdef AttOnG1_KeyOnG2
bool KPABE::decryptS(const shared_ptr<BLAccessPolicy> policy, vector<G2> keyFrags, const vector<int>& atts, const Big& CT,  vector<G1>& AttFrags, Big& PT)
#endif
#ifdef AttOnG2_KeyOnG1
  bool KPABE::decryptS(const shared_ptr<BLAccessPolicy> policy, vector<G1> keyFrags, const vector<int>& atts, const Big& CT,  vector<G2>& AttFrags, Big& PT)
#endif
{
  GT blinder;
...
#ifdef AttOnG1_KeyOnG2
bool KPABE::decrypt(const shared_ptr<BLAccessPolicy> policy, vector<G2> keyFrags, const vector<int>& atts, const GT& CT,  vector<G1>& AttFrags, GT& PT)
#endif
#ifdef AttOnG2_KeyOnG1
  bool KPABE::decrypt(const shared_ptr<BLAccessPolicy> policy, vector<G1> keyFrags, const vector<int>& atts, const GT& CT,  vector<G2>& AttFrags, GT& PT)  
#endif
{
  GT blinder;
  bool success = decrypt_main_body(policy, keyFrags, atts, AttFrags, blinder);
