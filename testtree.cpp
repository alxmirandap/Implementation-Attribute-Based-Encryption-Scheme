...
int testNode(int errors, NodeContent node, std::string base, NodeContentType type, std::string nodeID,
...
int testMakeNode() {
  ...
  NodeContent andNode = NodeContent::makeAndNode(12);
  ...
  NodeContent thrNode = NodeContent::makeThreshNode(7,3);
...
int testChildren(){  //append and get numbers
  ...
  NodeContent root = NodeContent::makeAndNode(3);
  ...
  NodeContent child1 = NodeContent::makeLeafNode(1);
  NodeContent child2 = NodeContent::makeLeafNode(2);
  NodeContent child3 = NodeContent::makeLeafNode(3);
  NodeContent child4 = NodeContent::makeLeafNode(4);
  ...
  DEBUG("child1 ID after append: " << child1.getNodeID());
  ...
  TreeNode leafTree = TreeNode(child3);
...
int testTreeConstruction(){ // computing the number of leaves and checking the general construction of the tree
  ...
  NodeContent root = NodeContent::makeOrNode(2);

  NodeContent node1 = NodeContent::makeLeafNode(12);
  NodeContent node2 = NodeContent::makeAndNode(3);
  
  NodeContent node21 = NodeContent::makeLeafNode(1);
  NodeContent node22 = NodeContent::makeThreshNode(2,1);
  NodeContent node23 = NodeContent::makeOrNode(3);

  NodeContent node221 = NodeContent::makeLeafNode(1);
  NodeContent node222 = NodeContent::makeLeafNode(2);

  NodeContent node231 = NodeContent::makeLeafNode(1);
  NodeContent node232 = NodeContent::makeLeafNode(10);
  NodeContent node233 = NodeContent::makeLeafNode(100);

  TreeNode tree = TreeNode(root);
  TreeNode verifTree1 = TreeNode(node1);
  TreeNode verifTree2 = TreeNode(node2);
