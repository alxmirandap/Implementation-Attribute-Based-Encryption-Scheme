...
class KPABE {
  ...
  bool decrypt_main_body(const shared_ptr<BLAccessPolicy> policy, vector<G2> keyFrags, const vector<int>& atts, vector<G1>& AttFrags, GT& blinder);
#endif
#ifdef AttOnG2_KeyOnG1
  ...
  bool decrypt_main_body(const shared_ptr<BLAccessPolicy> policy, vector<G1> keyFrags, const vector<int>& atts, vector<G2>& AttFrags, GT& blinder);
#endif
...
public:
  ...
  vector<G2> genKey(const shared_ptr<BLAccessPolicy> policy);
  vector<G2> genKey(const shared_ptr<BLAccessPolicy> policy, vector<Big> poly);
  ...
  bool decrypt(const shared_ptr<BLAccessPolicy> policy, vector<G2> keyFrags, const vector<int>& atts, const GT& CT,  vector<G1>& AttFrags, GT& PT);
  bool decryptS(const shared_ptr<BLAccessPolicy> policy,  vector<G2> keyFrags, const vector<int>& atts, const Big& CT,  vector<G1>& AttFrags, Big& PT);
#endif

#ifdef AttOnG2_KeyOnG1
  vector<G2>& getPublicAttributes();
  vector<G1> genKey(const shared_ptr<BLAccessPolicy> policy);
  vector<G1> genKey(const shared_ptr<BLAccessPolicy> policy, vector<Big> poly);
  ...
  bool decrypt(const shared_ptr<BLAccessPolicy> policy, vector<G1> keyFrags, const vector<int>& atts, const GT& CT,  vector<G2>& AttFrags, GT& PT);
  bool decryptS(const shared_ptr<BLAccessPolicy> policy,  vector<G1> keyFrags, const vector<int>& atts, const Big& CT,  vector<G2>& AttFrags, Big& PT);
#endif
};
